        ...
        <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
          ...
          <form method="post" id="registerCandidates" action="adduser.php" enctype="multipart/form-data">
            <div class="col-md-6 latest-job ">
              ...
              <div class="form-group">
                <input class="form-control input-lg" rows="4" type="text" id="experience" name="experience" placeholder="Experience" required>
              </div>
              <div class="form-group">
            ...
            <div class="col-md-6 latest-job ">
              ...
              <div class="form-group">
                <textarea class="form-control input-lg" rows="4" id="designation" name="designation" placeholder="Enter designation"></textarea>
              </div>              
