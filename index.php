    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <!-- logo for regular state and mobile devices -->
          ...
          <div class="col-sm-5 col-md-5">
              ...
              <img src="img/online.jpg" alt="Logo">
              
  </div>
      <span class="logo-lg"><b>Online Job</b> Portal</span>
    </a>
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li>
            <a href="#candidates">Job seekers</a>
          </li>
          <li>
          ...
          <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <span class="glyphicon glyphicon-log-in"></span> log-in <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="login-candidates.php">Jobseeker</a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="login-company.php">Employer</a></li>
                    </ul>
                </li>
          <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <span class="glyphicon glyphicon-user"></span> Sign-up <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="register-candidates.php">Jobseeker</a></li>
                        <li role="separator" class="divider"></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center index-head">
            <h1>READY TO TAKE THE NEXT STEP IN YOUR <strong>CAREER</strong> </h1>
        ...
        <div class="row">
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail candidate-img">
              <img src="img/search.jpg" alt="Browse Jobs">
              <div class="caption">
          ...
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail candidate-img">
              <img src="img/carer.jpg" alt="Start A Career">
              <div class="caption">
    ...
    <section id="company" class="content-header">
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center latest-job margin-bottom-20">
            <h1>Companies</h1>
            <p>Hiring? Register your company for free,
               browse our talented pool, post and track job applications</p>            
          </div>
        </div>
        <div class="row">
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail company-img">
              <img src="img/post.png" alt="Browse Jobs">
              <div class="caption">
          ...
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail company-img">
              <img src="img/images.jpg" alt="Start A Career">
              <div class="caption">
